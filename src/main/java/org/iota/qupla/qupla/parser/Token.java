...
public class Token
{
  ...
  public static final int TOK_FUNC = TOK_EVAL + 1;
  ...
  public static final int TOK_LITERAL_BITS = TOK_LIMIT + 1;
  public static final int TOK_LITERAL_FALSE = TOK_LITERAL_BITS + 1;
  public static final int TOK_LITERAL_FLOAT = TOK_LITERAL_FALSE + 1;
  public static final int TOK_LITERAL_HEX = TOK_LITERAL_FLOAT + 1;
  public static final int TOK_LITERAL_NUMBER = TOK_LITERAL_HEX + 1;
  public static final int TOK_LITERAL_TRITS = TOK_LITERAL_NUMBER + 1;
  public static final int TOK_LITERAL_TRUE = TOK_LITERAL_TRITS + 1;
  public static final int TOK_LITERAL_TRYTES = TOK_LITERAL_TRUE + 1;
  public static final int TOK_LUT = TOK_LITERAL_TRYTES + 1;
  ...
  public static final int TOK_PLUS = TOK_NULL + 1;
